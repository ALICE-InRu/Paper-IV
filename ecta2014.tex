...
\subfigure[][minimise w.r.t.~\cref{eq:cma:makespan}]{\epsfig{file={fig/CMAweightsEvo.ES_Cmax}.eps, width=\textwidth}\label{fig:cma:wei:cmax}}
\\
\subfigure[][minimise w.r.t.~\cref{eq:cma:rho}]{\epsfig{file={fig/CMAweightsEvo.ES_rho}.eps, width=\textwidth}\label{fig:cma:wei:rho}}
